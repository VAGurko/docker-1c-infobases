...
5. Создайте на основе файла `example-httpd.conf` новый файл `httpd.conf` в корневой директории проекта и укажите имя информационной базы в файле `httpd.conf` в самом конце, по умолчанию там используется `Base1C`.
